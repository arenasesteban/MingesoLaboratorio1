...
export default function OpcionSideBar({ enlace, nombreOpcion, iconoOpcion, iconoDropdown}) {
    ...
    return (
        <div class="mx-4 mt-auto">
            <a href={enlace} class="flex gap-3 items-center px-4 py-3 text-white font-semibold rounded-lg hover:bg-cyan-700 hover:shadow-md active:text-cyan-600 active:bg-white">
